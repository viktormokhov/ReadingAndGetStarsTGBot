...
from core.constants import KIND_TO_MESSAGE
...
def async_with_generating_flag(get_user_id, kind):
    ...
    def decorator(func):
        ...
        async def wrapper(*args, **kwargs):
            ...
            from core.services.users.user_flags import set_generating, clear_generating
...
def block_if_active_question(get_user_id):
    ...
    def decorator(func):
        ...
        async def wrapper(*args, **kwargs):
            ...
            user_id = get_user_id(*args, **kwargs)
            from core.services.users.user_flags import has_active_question
