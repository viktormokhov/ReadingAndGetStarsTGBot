...
from core.services.admin.admin_stats import render_user_stats
from core.services.admin.admin_user_service import fetch_user_stats
from handlers.ui.ui_admin import admin_pagination_kb, admin_back_menu_kb
...
@admin_only()
async def show_all_users(call: CallbackQuery, is_admin: bool):
    await call.answer()
...
@admin_only()
async def reset_user(call: CallbackQuery, is_admin: bool):
