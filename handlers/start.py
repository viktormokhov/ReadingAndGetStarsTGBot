...
from core.database.user_ops import get_or_create_user, update_user_age
from handlers.ui.ui_main import main_menu_inline_kb, build_access_request_keyboard
...
async def cmd_start(message: Message, state: FSMContext):
    ...
    user = await get_or_create_user(uid, message.from_user.full_name)
